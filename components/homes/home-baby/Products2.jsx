    ...
    <section className="flat-spacing-3 overflow-hidden">
      <div className="container">
        <div className="flat-title wow fadeInUp">
          <h3 className="display-lg-4 fw-bold title font-8 text-dark-orange">
            Parent-Approved Best Sellers
          </h3>
        </div>
        <div className="fl-control-sw2 wrap-pos-nav wow fadeInUp">
          ...
          <div
            className="d-none d-xxl-flex swiper-button-prev nav-swiper nav-prev-seller"
            style={{ top: "calc(50% - 45.6016px)" }}
          />
          <div
            className="d-none d-xxl-flex swiper-button-next nav-swiper nav-next-seller"
            style={{ top: "calc(50% - 45.6016px)" }}
          />
        </div>
      </div>
