          ...
          <div className="wrapper-sub-menu-tab flat-animate-tab">
            ...
            <div className="tab-content">
              {productMenuItems.map((elm, i) => (
                ...
                >
                  <ul className="menu-list">
                    {elm.links.slice(0, 8).map((link, i) => (
                      <li key={i}>
                        <Link
                          href={link.href}
                          className={`menu-link-text link  ${
      ...
      <li className="menu-item position-relative">
        ...
        <div className="sub-menu sub-menu-style-2">
          ...
          <div className="banner hover-img">
            <Link href={`/blog-single/1`} className="img-style">
              <Image
                alt="banner"
            ...
            <div className="content">
              ...
              <Link href={`/blog-single/1`} className="box-icon animate-btn">
            ...
            <ul className="list-recent-blog">
              {recentBlogPosts.map((post, index) => (
                <li className="item" key={index}>
                  <Link href={`/blog-single/${post.id}`} className="img-box">
                    <Image
                      alt={post.alt}
                      src={post.imageSrc}
                      width={post.width}
