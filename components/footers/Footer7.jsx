        ...
        <div className="container">
          <div className="row-footer">
            <div className="footer-col-block s1 border-0">
              ...
              <div className="footer-heading footer-heading-mobile text-xl fw-medium font-3 fst-italic d-sm-none d-flex">
                BUSINESS CONTACT
              </div>
            ...
            <div className="footer-inner-wrap s3 border-0 mb_20">
              <div className="footer-col-block inner-col">
                <div className="footer-heading footer-heading-mobile text-xl fw-medium font-3 fst-italic">
                  QUICK LINK
                </div>
                <div className="tf-collapse-content">
                  <ul className="footer-menu-list">
                    <li>
                      <Link className="font-11 body-text" href={`/about-us`}>
                        Our Story
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link className="font-11 body-text" href={`/contact-us`}>
                        Contact Us
                      </Link>
                    </li>
                    <li>
        ...
        <div className="container">
          <div className="footer-bottom-wrap">
            ...
            <ul className="d-flex gap-48 flex-wrap">
              <li>
                <Link className="link" href={`/term-and-condition`}>
                  Terms
                </Link>
              </li>
              <li>
