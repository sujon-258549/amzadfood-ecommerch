        ...
        <div className="container">
          <div className="row-footer">
            <div className="footer-col-block s1 border-0">
              ...
              <div className="footer-heading footer-heading-mobile text-xl fw-bold font-3 d-sm-none d-flex">
                Business Contact
              </div>
              <div className="tf-collapse-content">
                <div className="footer-contact">
                  ...
                  <a
                    ...
                    className="tf-btn btn-line-dark fw-normal mb_32"
                  >
              ...
              <div className="footer-col-block inner-col">
                ...
                <div className="tf-collapse-content">
                  <ul className="footer-menu-list">
                    ...
                    <li>
                      <Link href={`/store-location`}>Our Store</Link>
                    </li>
                    <li>
        ...
        <div className="container">
          <div className="footer-bottom-wrap">
            <p className="text-dark">
              ...
              <span className="fw-medium">Vineta.</span> All Rights Reserved.
            </p>
